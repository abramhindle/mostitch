...
class PrintStitch(Mostitch):
    def __init__(self, buffsize = 1024, state = {}):
        ...
        self.last = 'Z'
	self.d = {}
	self.d["A"] = "i1 0 0.01 1000 40 1 0.7 1.0 \"A\""
	self.d["B"] = "i1 0 0.01 1000 200 2 0.3 1.2 \"B\""
	self.d["C"] = "i1 0 0.01 1000 400 3 0.9 1.3 \"C\""
	self.d["D"] = "i1 0 0.01 1000 1600 4 0.3 1.5 \"D\""
